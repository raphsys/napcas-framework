...
from napcas import Transformer, DataLoader, CrossEntropyLoss, Adam, Tensor
...
def main():
    ...
    for epoch in range(10):
        ...
        optimizer.step()  # correction :contentReference[oaicite:0]{index=0}:contentReference[oaicite:1]{index=1}
